...
def categories(self, key, value):
    subject_list = [{"term": c, "scheme": "arXiv"} for c in value.split()]
...
def languages(self, key, value):
    languages = [
        ("en", "English"), ("rus", "Russian"), ("ger", "German"), ("fre", "French"),
...
def field_categories(self, key, value):
    return [{"term": t, "scheme": "INSPIRE", "source": "submitter"} for t in value]
