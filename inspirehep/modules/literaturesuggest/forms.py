...
class LiteratureForm(INSPIREForm):
    ...
    languages = [
        ("en", _("English")), ("rus", _("Russian")), ("ger", _("German")), ("fre", _("French")),
        ("ita", _("Italian")), ("spa", _("Spanish")), ("chi", _("Chinese")),
        ("por", _("Portuguese")), ("oth", _("Other"))
    ]
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.degree_type.choices = [
            (val, val) for val in current_app.config['INSPIRE_DEGREE_TYPES']
        ]
